...
class _HomePageState extends State<HomePage> {
  ...
  Widget build(BuildContext context) {
    var myNewFontWhite = GoogleFonts.pressStart2p(
      textStyle:
          TextStyle(color: Theme.of(context).colorScheme.inversePrimary, letterSpacing: 3, fontSize: 15));
    return Scaffold(
       appBar: AppBar(
  ...
  void _showWinDialog(String winner) {
    showDialog(
        ...
        builder: (BuildContext context) {
          return AlertDialog(
            title: Text('WINNER IS: $winner', style: TextStyle(color: Theme.of(context).colorScheme.inversePrimary,),),
            actions: <Widget>[
              TextButton(
                child: Text('Play Again!', style: TextStyle(
                    color: Theme.of(context).colorScheme.inversePrimary,
